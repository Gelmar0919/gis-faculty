{{-- d3 chart styles --}}
<link rel="stylesheet" href="{{ asset('userinterface/dist/css/ictcharts.css') }}">
...
{{-- MarkerCluster --}}
<link rel="stylesheet" href="{{ asset('userinterface/dist/css/MarkerCluster.css') }}">
<link rel="stylesheet" href="{{ asset('userinterface/dist/css/MarkerCluster.Default.css') }}">
 ...
 <!-- iCheck -->
 <link rel="stylesheet" href="{{ asset('userinterface/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
 <!-- Theme style -->
 <link rel="stylesheet" href="{{ asset('userinterface/dist/css/adminlte.min.css') }}">
<!-- overlayScrollbars -->
...
{{--  <!-- JQVMap -->
 <link rel="stylesheet" href="{{ asset('userinterface/plugins/jqvmap/jqvmap.min.css') }}"> --}}

 {{-- Leaflet pop --}}
{{-- <script src="{{ asset('userinterface/dist/css/leaflet.rrose.css') }}"></script> --}}

 {{-- <!-- Daterange picker -->
 <link rel="stylesheet" href="{{ asset('userinterface/plugins/daterangepicker/daterangepicker.css') }}"> --}}
{{--  <!-- summernote -->
 <link rel="stylesheet" href="{{ asset('userinterface/plugins/summernote/summernote-bs4.min.css') }}"> --}}
{{--  <!-- Ion Slider -->
