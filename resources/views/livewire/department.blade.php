<div>
    ...
    <div class="margin">
        ...
        <div class="btn-group pt-1">
        <button type="button" wire:click="addDepartment()" class="btn btn-block btn-outline-primary ">
      ...
      <table class="table text-nowrap table-striped">
        <thead>
          <tr>
            ...
            <th ><a role="button" wire:click.prevent="sortField('code')" style="width: 20%;">Department Code
              @include('set-sorting-icons',['field'=>'code'])
            </a></th>
            @endif
            @if($this->showColumn('department'))
            <th ><a role="button" wire:click.prevent="sortField('department')" style="width: 20%;">Department Name
              @include('set-sorting-icons',['field'=>'department'])
            </a></th>
            @endif
